                    ...
                    <div className="mt-12 pt-8 border-t">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mt-10">
                            <div className="h-full">
                                <div className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-cyan-500 text-center transition-transform transform hover:-translate-y-2 h-full">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="mt-12 text-center w-full max-w-sm">
                                ...
                                <div className="mt-4 flex flex-wrap justify-center items-center gap-3">
                                    <a href={`https://wa.me/?text=${encodedShareText}%20${encodedUrl}`} target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white w-10 h-10 rounded-full flex items-center justify-center text-xl hover:bg-green-600 transition-colors transform hover:scale-110" aria-label="Compartir en WhatsApp">
                                        <i className="fab fa-whatsapp"></i>
                                    </a>
                                    <a href={`https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}`} target="_blank" rel="noopener noreferrer" className="bg-blue-600 text-white w-10 h-10 rounded-full flex items-center justify-center text-xl hover:bg-blue-700 transition-colors transform hover:scale-110" aria-label="Compartir en Facebook">
                                        <i className="fab fa-facebook-f"></i>
                                    </a>
                                    <a href={`https://twitter.com/intent/tweet?url=${encodedUrl}&text=${encodedShareText}`} target="_blank" rel="noopener noreferrer" className="bg-sky-500 text-white w-10 h-10 rounded-full flex items-center justify-center text-xl hover:bg-sky-600 transition-colors transform hover:scale-110" aria-label="Compartir en Twitter">
                                        <i className="fab fa-twitter"></i>
                                    </a>
                                    <a href={`mailto:?subject=${encodedTitle}&body=${encodedShareText}%0D%0A%0D%0A${bookUrl}`} className="bg-gray-500 text-white w-10 h-10 rounded-full flex items-center justify-center text-xl hover:bg-gray-600 transition-colors transform hover:scale-110" aria-label="Compartir por correo electrónico">
                                        <i className="fas fa-envelope"></i>
                                    </a>
                                    <button onClick={handleCopy} className="bg-cyan-600 text-white h-10 px-4 rounded-full flex items-center justify-center text-sm hover:bg-cyan-700 transition-colors transform hover:scale-105">
                ...
                <AnimateOnScroll>
                    <section className="py-16 md:py-24 bg-gray-50/50 rounded-xl">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                            <div className="h-full">
                                <div className="bg-white p-6 rounded-lg shadow-lg text-center flex flex-col items-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 h-full">
