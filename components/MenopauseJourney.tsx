...
const TheFlightForwardSection: React.FC = () => {
    return (
        <section className="py-16 md:py-24">
            ...
            <div className="mt-12 max-w-3xl mx-auto text-gray-700 leading-relaxed text-justify space-y-4">
                {/* Bloque de cita visual e interactivo */}
                <div className="my-8 bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-gray-100 transform transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-100/50">
                    <div className="relative text-center">
                        <i className="fas fa-quote-left text-7xl text-cyan-100 absolute -top-4 left-1/2 -translate-x-1/2 opacity-80 z-0"></i>
                        <div className="relative z-10 text-xl text-gray-700 font-lora space-y-4">
                            <p>
                ...
                <h3 className="text-2xl font-bold font-lora pt-4 text-cyan-700">Mi Experiencia Real: El Terremoto Interior</h3>
                <p><strong>Cumplir 50 fue un hito.</strong> No solo por lo que representa en el calendario, sino porque marcó el inicio de una etapa que me enfrentó a mí misma de una forma que nunca imaginé.</p>
                <p>Siempre he sido una persona que se ha cuidado: he mantenido una alimentación equilibrada, he hecho ejercicio con regularidad, alejé de mi vida el tabaco y el alcohol, y dejé de trasnochar hace muchos años. Ya en la perimenopausia empecé a notar los primeros síntomas: cambios en el sueño, ansiedad leve, cierta fatiga. En ese momento logré compensarlos con magnesio y otros pequeños ajustes, y pensé que sería algo puntual. Pero cuando se retiró definitivamente mi ciclo menstrual, todo cambió.</p>
                <p>Los síntomas físicos se intensificaron: <strong>sofocos, sudoración nocturna, dolores musculares y articulares, insomnio, jaqueca, libido desaparecida, fatiga constante,</strong> sueño interrumpido que me dejaba agotada durante el día, picores en los oídos, intolerancias alimentarias, <strong>niebla mental, miedos infundados, irritabilidad, mareos frecuentes y palpitaciones</strong> que me asustaban sin razón aparente. Perdí la capacidad de concentración: no podía estar ni diez minutos frente al ordenador ni realizar tareas que exigieran atención.</p>
                <p>Pero lo más difícil fue lo que no se ve. La <strong>crisis existencial</strong> que se instaló dentro de mí, <strong>silenciosa pero devastadora.</strong> Empecé a cuestionarlo todo: quién era, qué sentido tenía mi vida, qué quedaba de mí. El <strong>sobrepensamiento se volvió constante, agotador.</strong> Mi mente no paraba, analizaba cada gesto, cada palabra, cada decisión, como si todo tuviera un peso desmesurado.</p>
                <p>Y mientras tanto, me sentía <strong>invisible.</strong> Como si mi entorno no me viera, como si lo que me pasaba no existiera para los demás. Nadie preguntaba, nadie entendía. Me esforzaba por disimular, por ocultar lo que estaba viviendo, por miedo al juicio, al “qué dirán”. La <strong>incomprensión dolía más que los síntomas.</strong></p>
                <p>Las responsabilidades seguían ahí: en casa, en el trabajo, las guardias, una mudanza... Yo cumplía, pero por dentro me desmoronaba. Era un <strong>vivir sin vivir en mí,</strong> atrapada en un cuerpo que no reconocía y en una mente que no me daba tregua. Y lo peor: hacerlo en silencio, sin que nadie lo note, sin que nadie lo entienda.</p>

                <h3 className="text-2xl font-bold font-lora pt-4 text-cyan-700">No Soy un Caso Aislado: La Soledad Compartida</h3>
                <p>Lo que me pasó lo veo cada día en consulta. Mujeres con mapas de síntomas distintos, pero todas comparten algo: una <strong>soledad profunda</strong> causada por la falta de información y comprensión. Una batalla silenciosa librada en casa, en el trabajo y contra nosotras mismas.</p>

                <h3 className="text-2xl font-bold font-lora pt-4 text-cyan-700">El Cambio de Mirada: La Gran Revelación</h3>
                <p>En medio de ese caos personal y profesional entendí algo central: la menopausia <strong>no es una enfermedad que haya que curar.</strong> Es una de las transiciones más importantes en la vida de una mujer, y la estamos atravesando a oscuras y en silencio. Esa comprensión lo cambió todo. Si bien es verdad que tenemos que empezar por hablar con nuestro médico de cabecera para descartar carencias, sobre todo vitaminas D y B12, hierro y calcio, y saber cómo están nuestras hormonas tiroideas, colesterol, cifras de glucosa y tensión arterial.</p>
                
                <h3 className="text-2xl font-bold font-lora pt-4 text-cyan-700">Mi Decisión Profesional: Construir un Puente</h3>
                <p>Decidí tomar las riendas de mi vida y <strong>construir un puente entre mi profesión y mi nueva realidad.</strong> Estudié, leí, escuché. Lo hice primero para ayudarme a mí misma, para entender lo que me estaba ocurriendo y recomponerme desde dentro. En ese proceso, descubrí que no estaba sola, que muchas mujeres atravesamos esta etapa en silencio, sin recursos ni acompañamiento.</p>
                ...
                <h3 className="text-2xl font-bold font-lora pt-4 text-cyan-700">Dónde Estoy Hoy: Aceptación y Propósito</h3>
                <p>Hoy sigo transitando esta etapa, pero lo hago desde otro lugar: más consciente, más encauzada. Trabajo en mis propios proyectos, exploro y pongo en valor mis talentos, liberada de la culpa y aceptando que esto es un proceso natural, no una falla.</p>
                <p>Mantengo rutinas que me sostienen y, sobre todo, escucho a muchas mujeres que, como yo, reclamamos ser tenidas en cuenta. Pedimos que se reconozca nuestra valía, nuestra experiencia, y también nuestro derecho a estar mal cuando las hormonas cambian y el cuerpo se transforma.</p>
                <p>Estamos vivas. Estaremos sin ciclos menstruales más de treinta años, y ese tiempo merece ser vivido con atención, apoyo y respeto. No queremos seguir en silencio: <strong>queremos ser vistas, comprendidas y acompañadas.</strong></p>
                <p>Escucho y acompaño desde <strong className="font-bold text-cyan-700">MILACIUDAD+</strong>, un espacio donde compartir, validar experiencias y ofrecer herramientas prácticas para transitar la menopausia con dignidad y sentido.</p>
                ...
                <div className="mt-12 pt-8 border-t">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mt-10">
                        <div className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-cyan-500 text-center transition-transform transform hover:-translate-y-2">
                    ...
                    <div className="mt-12 grid md:grid-cols-2 gap-10">
                        <div className="bg-white p-8 rounded-lg shadow-lg border-t-4 border-cyan-500 transition-transform transform hover:-translate-y-2 h-full flex flex-col">
        ...
        <section className="py-16 md:py-24">
            <div className="max-w-3xl mx-auto text-center">
                <div className="inline-block relative">
                    ...
                    <h2 className="text-4xl font-bold font-montserrat text-gray-700">Mi Historia</h2>
                </div>
...
const BookSection: React.FC = () => {
    const amazonReviews = [
      { author: 'Alma Velázquez', rating: 5, comment: 'Como pediatra, he compartido guardias, risas, urgencias y muchas familias atendidas junto a Mila. Y puedo decir con total tranquilidad que leer “Rescatando Padres” es casi como tenerla al lado en una consulta: clara, empática, resolutiva y siempre con una mirada serena, incluso en medio del caos. Este libro no solo ofrece primeros auxilios o consejos útiles para padres; transmite su forma única de cuidar, de explicar sin tecnicismismos, de escuchar sin juicio. Mila consigue que las familias se sientan acompañadas y, sobre todo, capaces. Para mí, que conozco su humanidad y su profesionalidad, este libro es exactamente lo que esperas de alguien que se dedica con el alma a los niños y sus familias. Un regalo necesario en cualquier hogar con peques.', verified: true },
      { author: 'Ángel Villarroel', rating: 5, comment: 'Como médico de urgencias, “Rescatando Padres” ha superado mis expectativas. Es un manual integral, una herramienta emocional y un recurso práctico. Su Guía de Primeros Auxilios Pediátricos es clara, actualizada y justifica por sí sola la compra. Combina lo físico con lo psicosocial de forma magistral. Se nota que está escrito desde la experiencia clínica y el amor de madre. No solo transmite conocimientos, sino confianza y calma. A partir de ahora, este es el libro que recomendaré a padres, abuelos y educadores. Felicito a Mila Ciudad por esta obra tan completa, humana y necesaria.', verified: true },
      { author: 'Ester', rating: 5, comment: '"Criar con calma es posible" por fin un verdadero manual de crianza respetuosa y emocionalmente inteligente. Rescatando Padres me acompaña en momentos de duda, estrés y agotamiento, ofreciéndome herramientas prácticas, consejos empáticos y hasta primeros auxilios pediátricos. Como madre primeriza, encontré en estas páginas una guía clara y reconfortante para criar con amor, paciencia y seguridad. Recomiendo este libro a todos los que buscan una crianza consciente, basada en el respeto y la conexión emocional. Una lectura imprescindible en cualquier biblioteca familiar.', verified: true }
    ];
        ...
        <section className="py-16 md:py-24 bg-cyan-50/30">
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    <h2 className="inline-block text-3xl md:text-4xl font-extrabold font-montserrat bg-white px-8 py-4 rounded-full shadow-lg border">
                        <span className="bg-gradient-to-r from-cyan-600 via-cyan-700 to-blue-500 bg-clip-text text-transparent animate-gradient-text">
                            SOY LA AUTORA DEL LIBRO <span className="block md:inline">RESCATANDO PADRES</span>
                        </span>
                    </h2>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="text-gray-700">
                        ...
                        <p className="mt-6 text-justify">Como madre y enfermera especializada en cuidados pediátricos, entiendo la crianza moderna: un mar de información que genera ansiedad y preocupación.</p>
                        ...
                        <p className="mt-4 text-justify">Es para padres, abuelos y educadores. Descubrirán temas cruciais: primeros días, alimentación, urgencias (con una vital <strong>Guía de Primeros Auxilios</strong>), cuidados, seguridad, adaptación escolar, desarrollo, emociones y vida familiar. La Guía de Primeros Auxilios es clave para transformar pánico en acción.</p>
                        <p className="mt-4 text-justify">Regalar "Rescatando Padres" es dar seguridad y calma. Mi doble experiencia, profesional y maternal, crea una guía rigurosa y humana. Nació de una vivencia personal: salvar a una niña. Me recordó la importancia de estar preparados.</p>
                        <p className="mt-6 font-bold text-xl text-cyan-700 text-center">Invierte en calma, invierte en seguridad. Es tu compañero de confianza.</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <a href="https://amzn.to/4qCo1xt" target="_blank" rel="noopener noreferrer" className="mt-8 inline-block bg-cyan-600 text-white font-bold py-3 px-10 rounded-full hover:bg-cyan-700 transition-colors shadow-lg transform hover:-translate-y-1">
                ...
                <div className="mt-24">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {amazonReviews.map((review, index) => (
                            <div key={index} className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-cyan-500 flex flex-col">
                                <StarRating rating={review.rating} />
                                <p className="text-gray-600 italic my-4 flex-grow">"{review.comment}"</p>
                                <div>
        ...
        <div className="bg-white text-gray-700 font-lora">
            <div className="container mx-auto px-6">
                ...
                <section className="py-16 md:py-24 text-center">
                    <h1 className="text-4xl md:text-5xl font-extrabold font-montserrat text-cyan-700">EN UNA VIDA HAY MUCHAS VIDAS: Mi viaje</h1>
                ...
                <section className="pb-16 md:pb-24">
                     <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
                        ...
                        <div className="animate-fade-in-right">
                           ...
                           <p className="mt-4 text-xl italic">"Enfermera especialista en Familiar y Comunitaria, mi vocación es el bienestar del cuerpo y el alma."</p>
                        </div>
                    </div>
                </section>
                
                <TheFlightForwardSection />
                ...
                <section className="py-16 md:py-24 bg-gray-50/50 rounded-xl">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {/* Card 1: Libro */}
                        <div className="bg-white p-6 rounded-lg shadow-lg text-center flex flex-col items-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                            ...
                            <p className="mt-2 text-gray-600 text-sm flex-grow">Mi experiencia en cuidados infantiles me llevó a escribir una guía para apoyar a los padres en esta etapa tan importante.</p>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg text-center flex flex-col items-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                            ...
                            <p className="mt-2 text-gray-600 text-sm flex-grow"><strong>"CANCIONES DE MI VIDA."</strong> un refugio sonoro para dar voz a mi alma y conectar con la tuya.</p>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg text-center flex flex-col items-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                            ...
                            <p className="mt-2 text-gray-600 text-sm flex-grow">Mi afán por afrontar la realidad con valentía y compartir esa fortaleza inquebrantable con quienes me leen y escuchan.</p>
